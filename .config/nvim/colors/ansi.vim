...
let s:status = [
    ...
    \ ['User3',        s:green[1],   s:black[0], ''],
    \ ['User4',        s:blue[1],    s:black[0], ''],
    \ ['User5',        s:yellow[1],  s:black[0], ''],
    \ ['User6',        s:yellow[0],  s:black[0], ''],
    \ ['User7',        s:red[0],     s:black[0], ''],
    \ ['User8',        s:magenta[1], s:black[0], ''],
    \ ['User9',        s:white[1],   s:black[0], ''],
    \ ['TabLine',      s:black[1],   s:white[0], ''],
    \ ['TabLineFill',  s:white[0],   s:black[1], ''],
    \ ['TabLineSel',   s:green[0],   s:black[0], 'reverse'],
    \ ['StatusLine',   s:white[1],   s:black[0], ''],
    \ ['StatusLineNC', s:white[1],   s:black[0], ''],
